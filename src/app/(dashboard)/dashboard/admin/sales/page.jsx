    ...
    <div className={`w-full min-h-screen bg-slate-50 pt-20 pb-12 px-4 md:px-8 transition-all duration-300 ${dashSidebar ? 'lg:pl-68' : 'lg:pl-8'}`}>
      <div className="max-w-6xl mx-auto flex flex-col gap-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-slate-200 pb-4 gap-4">
          <div>
            <h1 className="text-2xl font-black text-slate-800 tracking-tight">Admin Orders Desk</h1>
            <p className="text-xs text-slate-500 mt-1">Global administrative console for client orders, deliveries, and cancellations.</p>
          </div>
          <button
            onClick={fetchOrders}
            disabled={loading}
