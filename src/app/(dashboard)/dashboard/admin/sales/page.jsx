  ...
  return (
    <div className={`w-full min-h-screen bg-slate-50 pt-20 pb-12 px-2 sm:px-4 md:px-8 transition-all duration-300 ${dashSidebar ? 'lg:pl-64' : 'lg:pl-8'}`}>
      <div className="w-full max-w-7xl mx-auto flex flex-col gap-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center justify-between bg-white p-4 border border-slate-200 shadow-sm">
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto">
            ...
            <select
              ...
              className="px-3.5 py-2 bg-slate-50 border border-slate-200 text-slate-800 text-xs font-bold outline-none cursor-pointer capitalize transition"
            >
          ...
          {/* Search Input */}
          <div className="flex items-center gap-2 bg-slate-50 px-3 py-2 border border-slate-200 w-full sm:w-80 shadow-sm">
